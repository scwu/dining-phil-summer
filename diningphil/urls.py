...
urlpatterns = patterns('',
    ...
    (r'^routes/', 'diningphil.visualizations.views.routes'),
    (r'^industries/', 'diningphil.visualizations.views.industries'),
    (r'^company_types/', 'diningphil.visualizations.views.company_types'),
